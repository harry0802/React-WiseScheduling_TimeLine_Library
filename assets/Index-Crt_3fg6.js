import{c as o,j as e,r as g,l as N}from"./index-CBdAkR7r.js";const k=o.div`
  position: fixed;
  left: 0;
  right: 0;
  top: 0;
  ...
  `}
`;function x({backgroundImage:t,children:a}){return e.jsx(k,{$backgroundImage:t,children:a})}//! =============== 1. 設定與常量 ===============
...
`,at=o.div`
  ...
  display: ${t=>t.hidden?"none":"block"};
  z-index: 10;
`;function ot(){return e.jsx(x,{backgroundImage:"/React-WiseScheduling_TimeLine_Library/images/ProductionZoneD.jpg",children:e.jsx(et,{children:tt.map(t=>e.jsx(at,{gridArea:t.gridArea,children:e.jsxs(d,{status:t.status,children:[e.jsx(d.Header,{id:t.id,model:t.model}),e.jsx(d.Stats,{goodRate:t.goodRate,completionRate:t.completionRate})]})},t.id))})})}//! =============== 1. 設定與常量 ===============
const R={switchInterval:1e4,progressUpdateInterval:1e3};//! =============== 3. 核心資料結構 ===============
const u=[{component:_,name:"A區生產線",key:"zone-a"},{component:Q,name:"B區生產線",key:"zone-b"},{component:q,name:"C區生產線",key:"zone-c"},{component:ot,name:"D區生產線",key:"zone-d"}];//! =============== 4. 樣式定義 ===============
const rt=o.div`
  position: fixed;
  bottom: 0;
  left: 0;
...
`;function dt(){const[t,a]=g.useState(0),[r,s]=g.useState(100),p=g.useCallback(()=>{a(b=>(b+1)%u.length),s(100)},[]);g.useEffect(()=>{const b=100/(R.switchInterval/R.progressUpdateInterval),y=setInterval(()=>{s(w=>{const A=w-b;return A<0?(p(),100):A})},R.progressUpdateInterval);return()=>clearInterval(y)},[p]);const T=u[t].component,j=u[t].name;return e.jsxs(e.Fragment,{children:[e.jsx(T,{},u[t].key),e.jsx(rt,{"aria-label":`正在顯示${j}，${Math.round(r/10)}秒後切換`,children:e.jsx(it,{progress:r})})]})}export{dt as default};
