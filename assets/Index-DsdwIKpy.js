import{j as e}from"./vendor-mui-BwwhWuia.js";import{r as g}from"./vendor-react-CEU0ziL0.js";import{d as o,l as N}from"./vendor-styled-D2EzWVfU.js";import{a as k}from"./index-C_1yu6ni.js";import"./vendor-query-yrDjzXSM.js";import"./vendor-antd-CUY9U6fe.js";import"./vendor-date-C7fpNwus.js";const D=o.div`
  position: fixed;
  left: 0;
  right: 0;
  top: 0;
...
const R=g.createContext();//! =============== 4. Styled Components ===============
const I=o.div`
  border-radius: 20px;
...
function d({status:t="inactive",children:a}){const r=Object.keys(i).includes(t)?t:"inactive",s={status:r,isActive:r!=="inactive"};return e.jsx(R.Provider,{value:s,children:e.jsx(I,{$status:r,children:a})})}function M({id:t,model:a,statusText:r}){var p;const{status:s}=g.useContext(R);return e.jsxs(O,{children:[e.jsxs(L,{children:[e.jsx(H,{$status:s,children:t}),e.jsxs(B,{children:[e.jsx(U,{$status:s}),e.jsx(E,{$status:s,children:r||((p=i[s])==null?void 0:p.statusText)||i.inactive.statusText})]})]}),e.jsx(W,{$status:s,children:a!=="--"?a:"無數據"})]})}function P({goodRate:t=0,completionRate:a=0}){const{status:r,isActive:s}=g.useContext(R);return e.jsxs(G,{$status:r,children:[e.jsxs(f,{$isLeft:!0,children:[e.jsx($,{children:"良率"}),e.jsxs(C,{children:[e.jsx(v,{$isActive:s,$status:r,$type:"goodRate",children:t}),e.jsx(S,{$isActive:s,$status:r,$type:"goodRate",children:"%"})]})]}),e.jsxs(f,{$isLeft:!1,children:[e.jsx($,{children:"完成率"}),e.jsxs(C,{children:[e.jsx(v,{$isActive:s,$status:r,$type:"completionRate",children:a}),e.jsx(S,{$isActive:s,$status:r,$type:"completionRate",children:"%"})]})]})]})}//! =============== 6. 組合元件 ===============
...
const h={switchInterval:1e4,progressUpdateInterval:1e3};//! =============== 3. 核心資料結構 ===============
...
`;function ut(){k("工廠績效儀表板");const[t,a]=g.useState(0),[r,s]=g.useState(100),p=g.useCallback(()=>{a(b=>(b+1)%u.length),s(100)},[]);g.useEffect(()=>{const b=100/(h.switchInterval/h.progressUpdateInterval),j=setInterval(()=>{s(w=>{const A=w-b;return A<0?(p(),100):A})},h.progressUpdateInterval);return()=>clearInterval(j)},[p]);const T=u[t].component,y=u[t].name;return e.jsxs(e.Fragment,{children:[e.jsx(T,{},u[t].key),e.jsx(it,{"aria-label":`正在顯示${y}，${Math.round(r/10)}秒後切換`,children:e.jsx(st,{progress:r})})]})}export{ut as default};
