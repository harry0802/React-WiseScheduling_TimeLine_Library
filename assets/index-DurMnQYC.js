import{d as m,r as S,j as t,B as k,T as j,a as D,C as Y,G as l,b as X,A as oe,l as ee,c as y,P as ne}from"./index-CBdAkR7r.js";import{i as ae,a as ie,b as le,d as ce,u as de,t as ue,D as te,C as me,M as P,A as he,c as pe,e as U,f as q,g as Q,h as re,z as i,j as ge,k as K,l as xe,m as fe,F as be,S as Te,n as je,o as se,T as Se}from"./moment-DMIOaRI2.js";import{S as G}from"./Stack-EkkCyrHK.js";//! =============== 1. 設定與常量 ===============
const ve="Asia/Taipei";//! =============== 2. 初始化設定 ===============
[ae,ie,le,ce,de,ue].forEach(e=>m.extend(e));m.tz.setDefault(ve);//! =============== 3. 核心功能 ===============
const O=(e,r=m())=>{const s=r,o=8,d={hour:{start:s.subtract(1,"hour"),end:s.add(1,"hour")},day:{start:s.startOf("day").hour(o),end:s.endOf("day").startOf("hour")},week:{start:s.startOf("week").hour(o),end:s.endOf("week").startOf("hour")},month:{start:s.startOf("month").hour(o),end:s.endOf("month").startOf("hour")}};return d[e]||d.day};//! =============== 4. 工具函數 ===============
...
`;const it={current:"現在",time:"時間",deleteSelected:"刪除選取",editable:{add:"新增",remove:"刪除",updateTime:"調整時間",updateGroup:"調整群組"}},lt={months:"一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),monthsShort:"1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),weekdays:"星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),weekdaysShort:"週日_週一_週二_週三_週四_週五_週六".split("_"),weekdaysMin:"日_一_二_三_四_五_六".split("_"),meridiem:(e,r)=>{const s=e*100+r;return s<600?"凌晨":s<900?"早上":s<1130?"上午":s<1230?"中午":s<1800?"下午":"晚上"},meridiemParse:/凌晨|早上|上午|中午|下午|晚上/,meridiemHour:(e,r)=>{let s=e===12?0:e;return["凌晨","早上","上午"].includes(r)?s:r==="中午"?s>=11?s:s+12:["下午","晚上"].includes(r)?s+12:s}},ct={orientation:"top",zoomable:!1,moveable:!0,stack:!0,stackSubgroups:!0,verticalScroll:!0,horizontalScroll:!0,showCurrentTime:!0,locale:"zh-TW",snap:null,locales:{"zh-TW":it},moment:e=>se(e).locale("zh-tw").utcOffset("+08:00")},dt={minorLabels:{millisecond:"SSS",second:"s秒",minute:"a h:mm",hour:"a h點",weekday:"M月D日",day:"D日",week:"第w週",month:"M月",year:"YYYY年"},majorLabels:{millisecond:"HH:mm:ss",second:"M月D日 a h:mm",minute:"M月D日 a h:mm",hour:"M月D日 a",weekday:"YYYY年M月",day:"YYYY年M月",week:"YYYY年M月",month:"YYYY年",year:""}},M={container:`
...
`,ht=e=>{var o;console.log("🚀 ~ createItemTemplate ~ item:",(o=e.orderInfo)==null?void 0:o.process);const r=m(e.start).format("HH:mm"),s=m(e.end).format("HH:mm");return e.timeLineStatus===n.ORDER_CREATED?ut(e):mt(e.timeLineStatus,r,s)};m.locale("zh-tw");se.updateLocale("zh-tw",lt);//! =============== 2. 類型與介面 ===============
//! =============== 3. 核心功能 ===============
const ft=()=>{const e=S.useRef(null),r=S.useRef(null),[s,o]=S.useState("day"),{itemsDataRef:d,groups:g}=Ke(),{dialogState:p,setDialogState:u,isDeleteDialogOpen:x,handleSaveItem:T,handleDeleteItem:h,handleAddItem:b,handleMoveToNow:c,closeDialog:f,openDeleteDialog:N,closeDeleteDialog:W}=Ze(r,d,s),C=S.useCallback(()=>{const E=O(s);return{...ct,...De[s],editable:{add:!1,updateTime:!0,updateGroup:!0},onMove:function(w,R){R(w)},format:dt,start:E.start.toDate(),end:E.end.toDate(),snap:null,orientation:{axis:"top",item:"top"},margin:{item:{vertical:8}}}},[s]),a=S.useCallback(()=>{if(!e.current||!d.current||!g)return;const E={...C(),template:ht};r.current?(r.current.setOptions(E),r.current.setData({items:d.current,groups:g})):(e.current.innerHTML="",r.current=new Se(e.current,d.current,g,E))},[g,C]),v=S.useCallback(()=>{if(!r.current)return;const E=w=>{var H;if(!w.item)return;const R=(H=d.current)==null?void 0:H.get(w.item);R&&u({selectedItem:R,mode:"edit",isOpen:!0})};return r.current.on("doubleClick",E),()=>{var w;return(w=r.current)==null?void 0:w.off("doubleClick",E)}},[u]);return S.useEffect(()=>{try{a();const E=v();return()=>{E==null||E(),r.current&&(r.current.destroy(),r.current=null)}}catch(E){console.error("Timeline 操作失敗:",E)}},[a,v]),t.jsxs(X,{sx:{p:4},children:[t.jsx(et,{children:t.jsx(tt,{children:t.jsx(st,{children:t.jsx(ot,{children:t.jsx(rt,{children:t.jsx(nt,{children:t.jsxs(at,{children:[t.jsx(Re,{timeRange:s,onTimeRangeChange:o,onAddItem:b,onMoveToNow:c}),t.jsx(ne,{ref:e,elevation:1,sx:{border:1,borderColor:"grey.200",borderRadius:1}})]})})})})})})}),p.selectedItem&&t.jsx(Ve,{open:p.isOpen,onClose:f,item:p.selectedItem,mode:p.mode,onSave:T,onDelete:N,groups:g}),t.jsx(Ae,{open:x,title:"刪除確認",content:"確定要刪除這個訂單嗎？",onConfirm:h,onCancel:W,confirmText:"刪除",cancelText:"取消"})]})};export{ft as default};
