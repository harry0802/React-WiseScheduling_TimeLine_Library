...
const formFields = [
  { name: "building", label: "棟舍", type: "input", span: 8 },
  { name: "pen", label: "欄位", type: "input", span: 8 },
  { name: "breed", label: "品種", type: "input", span: 8 },
  { name: "ear_tag", label: "耳號", type: "input", span: 8 },
  ...
  { name: "reason", label: "原因", type: "input", span: 8 },
  { name: "departure_date", label: "離場日期", type: "date", span: 8 },
];
