...
export const pigHouseInventoryConfig = {
  ...
  formFields: [
    { name: "date", label: "日期", type: "date", span: 8 },
    { name: "totalPigs", label: "總隻數", type: "number", span: 8 },
    { name: "totalDeaths", label: "總死亡數", type: "number", span: 8 },
    { name: "totalSold", label: "總出售", type: "number", span: 8 },
