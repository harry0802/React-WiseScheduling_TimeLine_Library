...
export const useProcessForm = ({ initialData, externalMethods, visible }) => {
  ...
  const initialValues = useMemo(
    () => ({
      ...initialData,
      ...initialData?.FQMaterialCostSetting,
      ...initialData?.FQInjectionMoldingCosts?.[0],
      processCategory: initialData?.processCategory || "",
      processSN: initialData?.processSN || "",
      activeTab: DEFAULT_ACTIVE_TAB,
      FQMaterialCosts: initialData?.FQMaterialCosts || [],
      FQPackagingCosts: initialData?.FQPackagingCosts || [],
      FQInPostProcessingCosts: initialData?.FQInPostProcessingCosts || [],
      FQOutPostProcessingCosts: initialData?.FQOutPostProcessingCosts || [],
      FQInjectionMoldingCosts: initialData?.FQInjectionMoldingCosts || [],
    }),
    [initialData]
  );
