...
import { useHandleLotChanges } from "../../../../ProductionInspection/useHandleLotChanges";
...
export default function QuantityInput(props) {
  ...
  // 使用QMS的樣式
  const StyledDiv = styled("div")(styles.quantityInput);

  return (
    <StyledDiv className="qms-record-card">
      <label>{label}</label>
      <NumberInput
