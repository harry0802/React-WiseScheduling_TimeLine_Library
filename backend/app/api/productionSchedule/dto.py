...
class productionScheduleDto:
    ...
    productionSchedule_object = api.model(
        "productionSchedule object",
        {
            ...
            "productionArea": fields.String(required=True, description="productionSchedule productionArea", example="A"),
            "machineSN": fields.String(required=True, description="productionSchedule machineSN", example="A1"),
            ...
            "moldingSecond": fields.Integer(required=True, description="productionSchedule moldingSecond", example=30),
            "planOnMachineDate": fields.Date(required=True, description="productionSchedule planOnMachineDate"),
            "actualOnMachineDate": fields.Date(required=False, description="productionSchedule actualOnMachineDate"),
            "moldWorkDays": fields.Integer(required=True, description="productionSchedule moldWorkDays", example=1),
            "workDays": fields.Integer(required=True, description="productionSchedule workDays", example=1),
            "planFinishDate": fields.Date(required=True, description="productionSchedule planFinishDate"),
            ...
            "dailyWorkingHours": fields.Integer(required=True, description="productionSchedule dailyWorkingHours", example=8),
            "moldCavity": fields.Integer(required=True, description="productionSchedule moldCavity", example=2),
            "week": fields.Integer(required=False, description="productionSchedule week"),
            "singleOrDoubleColor": fields.String(required=True, description="productionSchedule singleOrDoubleColor", example="single"),
            "conversionRate": fields.Float(required=True, description="productionSchedule conversionRate", example=0.95),
            "status": fields.String(required=True, description="productionSchedule status"),
